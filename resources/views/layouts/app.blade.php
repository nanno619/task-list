...
<head>
    ...
    <style type="text/tailwindcss">
        ...
        .link {
            @apply font-medium text-sm text-gray-700 border rounded-full shadow-sm border-gray-700 px-4 py-2 hover:bg-slate-800 hover:text-white
        }
        label{
...
<body class="container mx-auto mt-10 mb-10 max-w-lg">
    <h1 class="font-sans text-xl font-semibold mb-4">@yield('title')</h1>
